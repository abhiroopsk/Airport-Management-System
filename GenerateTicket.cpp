...
public:
    ...
    {
        cout<<"here at boarfing class"<<endl;
        getch();
...
void GenerateTicket::UserCopy()
{
    ...
    ofstream fout(fname + ".txt");
    fout <<setw(40)<<setiosflags(ios::left)<< name ;
    fout << "Airline Company: " << airlineCompany << endl;
    fout <<setw(40)<<setiosflags(ios::left)<< age ;
    fout << "Boarding Date: "<<date << endl;
    fout << "EMAIL ID    : " <<setw(26)<<setiosflags(ios::left)<< email ;
    ...
    fout << "Amount Paid: " <<setw(27)<<setiosflags(ios::left)<< price;
    fout << "Boarding Time: "<< get<0>(time)<<endl;
    fout <<setw(40)<<setiosflags(ios::left)<< contact_no;
    fout << "Landing Time: "<< get<1>(time)<<endl;
    fout <<setw(40)<<setiosflags(ios::left)<< "Seat Number  : "
